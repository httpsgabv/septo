...
| `reminders` | Web Push: assinaturas, scheduler na API, disparo, service worker/PWA | notes | [SPEC-reminders](specs/SPEC-reminders.md) · [plano](tasks/reminders/plan.md) · spec aprovada |
