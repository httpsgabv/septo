...
| `identity` | Login de usuário único (username + senha), sessão JWT em cookie httpOnly, guard de rotas (API e web), perfil (nome de exibição), troca de senha, sair de todos | foundation | [SPEC-identity](specs/SPEC-identity.md) · 📝 rascunho |
